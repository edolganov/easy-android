 ...
 */
package easydroid.gf.extra.scan;
...
/**
 * Interface for package scanning. Used for {@link easydroid.gf.core.Engine#scanAndPut(String)} logic.
 * <br>There are two default implementations: 
 * <ul>
 * 	<li>{@link easydroid.gf.core.scan.DefaultClassScanner}: for standalone app, Tomcat Web Server</li>
